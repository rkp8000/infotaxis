...
empirical trajectories and matched infotaxis trajectories. This plot overlays results from initial and noninitial encounter sets.
"""
                ...
                for ens in seg_group.analysis_triggered_ensembles:
                    ...
                    if c == 'initial':
                        conditions += (ens.encounter_number_min == 1,
                                       ens.encounter_number_max == 1,)
                    elif c == 'noninitial':
                        conditions += (ens.encounter_number_min == 2,
