"""
Plot a histogram of the number of hits received as a result of discretizing the 9 different sets of experimental trajectories (3 wind speeds, 3 odor states).
"""
...
from config.wind_tunnel_discretized_hit_number_histogram import *
