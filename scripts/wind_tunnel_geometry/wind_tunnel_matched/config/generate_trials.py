...
SIMULATIONID = 'wind_tunnel_matched_fruitfly_0.4mps_odor_afterodor'
SIMULATIONDESCRIPTION = 'Creates large set of trajectories with starting positions and durations drawn randomly from ' \
                        'true wind tunnel dataset for fruit flies flying in 0.4 m/s wind with odor off, but geometric configs taken from afterodor case.'
