...
SCRIPT_NOTES = 'Run for all odor states and experiments keeping only crosswind crossings (heading between 60 and 120 degs), and only keeping first and second encounters. Also throw out everything in upwind or downwind 30 cm of wind tunnel.'
